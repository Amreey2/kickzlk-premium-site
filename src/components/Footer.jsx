...
export default function Footer() {
  return <footer className="footer">
    <div className="container footer-grid">
      <div className="footer-brand"><img src={logoWordmarkWhite} alt="KICKZ.LK" /><p>Premium authentic sneakers, imported for Sri Lanka’s culture.</p><SocialIconLinks className="footer-socials" /></div>
