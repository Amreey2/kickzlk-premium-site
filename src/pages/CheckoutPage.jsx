    ...
    <PageShell>
      ...
      <section className="checkout-section section-pad">
        <div className="container checkout-layout">
          <CheckoutSummary product={product} selectedSize={selectedSize} setSelectedSize={(size) => { setSelectedSize(size); setReady(false); }} />
          {/* SPRINT 3.2 CHECKOUT PREPARATION: validates locally and prepares a WhatsApp handoff without processing payment. */}
          <form className="checkout-form customer-form" onSubmit={handleSubmit} noValidate>
            <div className="checkout-heading"><span className="section-kicker">CUSTOMER DETAILS</span><h2>DELIVERY INFORMATION</h2></div>
            ...
            <div className="form-row">
              ...
              <FormField label="PHONE NUMBER" name="phone" type="tel" value={customer.phone} onChange={updateField} error={errors.phone} autoComplete="tel" placeholder="+94 7X XXX XXXX" />
            </div>
            ...
            <button className="btn btn--acid" type="submit">REVIEW DETAILS <span>→</span></button>
            {ready && <a className="btn btn--whatsapp checkout-whatsapp" href={whatsappUrl} target="_blank" rel="noopener noreferrer">CONFIRM VIA WHATSAPP <span>↗</span></a>}
          </form>
        </div>
      </section>
    </PageShell>
