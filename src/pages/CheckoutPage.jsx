      ...
      <section className="checkout-section section-pad">
        <div className="container checkout-layout">
          ...
          <form className="checkout-form customer-form" onSubmit={handleSubmit} noValidate>
            <div className="checkout-heading"><span className="section-kicker">CUSTOMER INFORMATION</span><h2>DELIVERY DETAILS</h2><p>Continue as a guest, or use the same email as your KICKZ.LK account to keep your order details together.</p></div>
            ...
            <aside className="guest-checkout-note"><span>GUEST CHECKOUT</span><p>No account is required. Creating an account later makes saved information, order history and tracking easier to access.</p><a href="/register">VIEW ACCOUNT BENEFITS →</a></aside>
